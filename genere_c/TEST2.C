...
struct TEIF_NomFeature global_nomfeature_tab1[2]={&(global_nomfeature[1])};
...
struct TEIF_Feature global_feature_tab0[1]={&(global_feature[0])};


struct TEIF_Creation global_creation[1]={
{NULL,&(global_nomfeature_tab1),0,1}};

struct TEIF_Creation global_creation_tab0[1]={&(global_creation[0])};
